  ...
  return (
    <footer className="relative bg-[#010a14] overflow-hidden">
      ...
      <div className="relative">
        {/* Contact bar */}
        <div>
          <div className="max-w-6xl mx-auto ps-6 lg:ps-12 lg:pe-14 py-10">
            <div className="flex flex-col md:flex-row md:justify-between gap-6">
              <div>
                <p className="text-white text-[13px] font-[400] mb-1">Supporto</p>
                <p className="text-white text-[15px] font-[500]">info@idasolar.it</p>
              </div>
              <div>
                <p className="text-white text-[13px] font-[400] mb-1">Assistenza Clienti</p>
                <p className="text-white text-[15px] font-[500]">02 8079 4991</p>
              </div>
              <div>
                <p className="text-white text-[13px] font-[400] mb-1">La nostra posizione</p>
        ...
        {/* Main footer */}
        <div>
          <div className="max-w-6xl mx-auto px-6 lg:px-12 pt-22 pb-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr] gap-10">
              ...
              <div>
                <Image
                  ...
                  height={24}
                />
                <p className="mt-6 text-[11px] text-white leading-[1.1] max-w-xs font-[500] text-justify">
                  ...
                  <ul className="space-y-4">
                    {col.links.map((label) => (
                      <li key={label}>
                        <a
                          href="#"
                          className="text-[13px] text-white hover:text-white/70 transition-colors font-[400]"
                        >
                          {label}
                        </a>
                      </li>
            ...
            {/* Bottom */}
            <div className="mt-14 text-center text-[12px] text-white font-[400]">
