      ...
      <div className="relative z-10 h-full flex items-center pt-[110px]">
        <div className="max-w-5xl mx-auto px-6 lg:px-12 w-full">
          <div className="max-w-md">
            ...
            <p className="mt-1 text-[16px] font-medium text-white italic">
              progettata per il futuro
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                href="#sistemi"
                className="bg-white text-ida-dark-bg border border-white hover:bg-transparent hover:border-white/60 hover:text-white px-4 py-2 rounded-[3px] text-[12px] font-medium transition-colors"
              >
                Scopri i Sistemi
              </a>
              <a
                href="#contattaci"
                className="bg-ida-green hover:bg-ida-green-dark text-white px-4 py-2 rounded-[3px] text-[12px] font-medium transition-colors"
              >
                Richiedi Consulenza
              </a>
            </div>
