export default function MadeInItaly() {
  return (
    <section className="py-16 lg:py-20 mt-8 bg-white">
      <div className="max-w-5xl mx-auto ps-0 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
          <div>
            <p className="font-heading text-[30px] tracking-tighter text-ida-dark-bg font-medium">
              Produzione
            </p>
            <h2 className="font-heading text-[30px] font-semibold tracking-normal text-ida-dark-bg leading-none">
              MADE IN ITALY
            </h2>
          </div>
