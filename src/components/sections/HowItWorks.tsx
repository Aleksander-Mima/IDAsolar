  ...
  return (
    <section>
      ...
      <div className="bg-white py-20 lg:pt-24 lg:pb-32 3xl:pt-32 3xl:pb-40 4xl:pt-40 4xl:pb-48">
        <div className="max-w-7xl 3xl:max-w-[1380px] 4xl:max-w-[1600px] mx-auto px-6 lg:px-12 3xl:px-16 4xl:px-20">
          <div className="text-center mb-16 3xl:mb-20 4xl:mb-24">
            ...
            <p className="mt-2 3xl:mt-4 4xl:mt-5 text-[14px] 3xl:text-[17px] 4xl:text-[19px] text-ida-dark-bg max-w-2xl 3xl:max-w-3xl 4xl:max-w-4xl mx-auto leading-[1.2] font-[450] tracking-tight">
              L&apos;approccio Ida Solar integra progettazione, tecnologia e gestione energetica per <br /> trasformare edifici e infrastrutture in sistemi di produzione energetica affidabili.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 3xl:gap-14 4xl:gap-16">
            {steps.map((step) => (
              <div key={step.title} className="text-center">
                ...
                <p className="text-[12px] 3xl:text-[15px] 4xl:text-[17px] text-[#888888] leading-[1.1] font-[450] max-w-[340px] 3xl:max-w-[400px] 4xl:max-w-[450px] mx-auto tracking-tight">
                  {step.description}
                </p>
              </div>
            ))}
