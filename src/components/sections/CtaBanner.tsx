          ...
          <div className="bg-ida-green rounded-xl px-8 lg:px-10 py-5 lg:py-5 3xl:px-14 3xl:py-8 4xl:px-16 4xl:py-10">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5 lg:gap-0">
              ...
              <div className="flex flex-wrap gap-4 3xl:gap-5 4xl:gap-6">
                <a
                  href="#sistemi"
                  className="bg-white text-ida-dark-bg px-5 py-2.5 lg:px-4 lg:py-2 3xl:px-5 3xl:py-2.5 4xl:px-6 4xl:py-3 text-[13px] lg:text-[12px] 3xl:text-[14px] 4xl:text-[16px] font-[500] hover:bg-white/90 transition-colors"
                >
                  Scopri i Sistemi
                </a>
                <a
